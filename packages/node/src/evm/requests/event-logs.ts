...
// NOTE: The generic parameter have a better default value (unknown instead of any) but doing so would make the tests
// less readable because a lot of type casting would be needed.
